...
<xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html>
        ...
        <div class="container">
          ...
          <div class="contentblock">
            ...
            <div class="rightsidebar">
              <!--Begin rightsidebar-->
              <h1>Navigate The Bible</h1>
              <h2>Go To Bible Reference</h2>
              ...
              <!--End versenavigation-->
              <h2>Chapter [<xsl:value-of select="/bible/book/attribute::title"/>]</h2>
          ...
          <div class="footerblock">
            <!--Begin footerblock-->
            Copyright <xsl:text disable-output-escaping="yes">&amp;copy;</xsl:text> 2014 ToDo Bible. All rights reserved.<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;</xsl:text><a href="#top">Top of page</a>
          </div>
          <!--End footerblock-->
        </div>
        <!--End container-->
  ...
  <xsl:template name="ChapterHeading">
    ...
    <!-- Generate header/footer for this chapter -->
